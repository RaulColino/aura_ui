...
class AText extends Text {
  ...
  AText(
    ...
    double? fontSize = 14,
    this.fontWeight = AFontWeight.regular,
    FontStyle? fontStyle,
    ...
    String? debugLabel,
    this.fontFamily = AFontFamily.inter,
...
//Alternative version:
  ...
  //   Color? backgroundColor,
  //   double? fontSize = 72,
  //   this.fontWeight = AFontWeight.bold,
  //   FontStyle? fontStyle,
  //   double? letterSpacing = -1.44,
  //   double? wordSpacing,
  //   TextBaseline? textBaseline,
  //   double? height = 1.08333,
  //   Paint? foreground,
  //   Paint? background,
  //   List<Shadow>? shadows,
  //   List<FontFeature>? fontFeatures,
